    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    <h2 className="text-3xl font-bold tracking-tight">Danh mục Thuốc</h2>
                    <p className="text-muted-foreground">Định nghĩa danh sách thuốc và hoạt chất. Quản lý kho tại <b>Nhà thuốc &gt; Kho</b>.</p>
                </div>
            ...
            <Card>
                <CardHeader>
                    <div className="flex items-center justify-between">
                        <CardTitle>Danh sách định nghĩa</CardTitle>
            ...
            <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                <DialogContent className="max-w-lg">
                    <DialogHeader>
                        <DialogTitle>{currentId ? "Sửa thông tin thuốc" : "Thêm thuốc mới"}</DialogTitle>
                        <DialogDescription>Chỉnh sửa các thông tin cơ bản. Giá và tồn kho được quản lý riêng.</DialogDescription>
                    </DialogHeader>
